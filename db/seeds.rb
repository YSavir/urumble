...
sean_blanton_review = sean.reviews.create(:comment => "Balls to the walls crap chicken, but protein is protein and dude's gotta get pumped", :dining_hall_id => blanton.id, :rating => 5)

# Photos
potato_photo = yaniv_blanton_review.photos.create(:student_id => yaniv.id, :dining_hall_id => blanton.id, :url => "/images/734920.png")
Photo.create(:dining_hall_id => bohn.id, :student_id => sean.id, :url => "images/u408uo4joi.png")
